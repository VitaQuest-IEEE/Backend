...
<footer class="footer footer-static footer-light">
    <p class="clearfix blue-grey lighten-2 mb-0"><span class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2024<a
                class="text-bold-800 grey darken-2" href="https://www.facebook.com/profile.php?id=61556618071735" target="_blank">True,</a>All rights Reserved</span><span
...
<script>
    ...
    document.getElementById('notifications-icon').addEventListener('click', function() {
        ...
        // AJAX call to mark notifications as read
          fetch('{{ url('admin/notification/markAsRead') }}', {
            method: 'POST',
            headers: {
